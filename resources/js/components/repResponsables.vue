<template>
    ...
    <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Responsables</h1> 
        </div>
    </div>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body table-responsive">
                <DataTable :data="Responsables" :columns="columns" class="table table-striped table-bordered display"
...
export default {
    ...
    methods : {
        buscarActivo(){
            let me=this;
            var url = '/responsable/repResponsables';
            axios.get(url).then((res)=>{
                me.Responsables= res.data.responsable;
            }
            ).catch((e)=>{
            console.log(e);
            })
